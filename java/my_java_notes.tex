...
\begin{itemize}
	...
	\item \url{http://www.javapractices.com/home/HomeAction.do;jsessionid=30B15108A7091DF24625AA7794107BE8} 
...
\begin{itemize}
	...
	\item investigate further application of 'characteristic' parameter of Collectors.of() - custom collector
...
\begin{tabular}{l || l | l}
	...
	\hline
	memory content & \textbf{references} to data & \textbf{atual} data \\
	\hline
...
\subsection{Define no-arg Constructor when a Constructor Taking Arguments Is Present }
	\item Always put no-arg constructor definition when there is at least one constructor taking argument.
...
In order to call methods that are not overridden the reference variable used to access the methods (here - \textit{pc}) must be cast to (Child)}}
...
Accumulator is of BinaryOperator\textless T, T\textgreateris type. It is  like a BiFuncion (but both parameters are of the same type) 
